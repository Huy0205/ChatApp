...
function Chat() {
    ...
    const handleSendMessage = async (type = 'text', content = textMessage) => {
        try {
            ...
            socket.emit('reRenderConversations', {members:conversation.recieveInfor.members,lastMessage
                ,unseen:1,conversationId:conversation._id,sendAt:new Date().toISOString()});
    ...
    return (
        <div id="chat_container" className={clsx('position-relative')}>
