...
export default function Slider() {
  ...
  return (
    <div className="wp_slider position-relative">
      ...
      <div id="carouselExampleDark" style={{marginTop:"120px"}} className="carousel carousel-dark slide" data-bs-ride="carousel">
        ...
        <div className="carousel-inner">
          ...
          <div className="carousel-item">
            <img src="https://chat.zalo.me/assets/inapp-welcome-screen-03.3f97d49ceecb950d95382b3d8fd4f0f1.png" className="d-block w-100" alt="..." />
            <div className="carousel-caption d-none d-md-block">
